package org.betteropenwith.settings;
...
// get attributes specified in XML
        ...
        try {
            ...
            summaryKey = a.getString(R.styleable.NumberPickerDialogPreference_summaryKey);
        } finally {
            a.recycle();
        }
...
// when the user selects "OK", persist the new value
        if (positiveResult) {
            ...
            if (callChangeListener(numberPickerValue)) {
                ...
                setSummary(String.format(summaryKey, numberPickerValue));
            }
        }
    }
    ...
    public CharSequence getSummary() {
        if (mNumberPicker == null) {
            return String.format(summaryKey, getPersistedInt(DEFAULT_VALUE));
        }
        return String.format(summaryKey, mNumberPicker.getValue());
    }
